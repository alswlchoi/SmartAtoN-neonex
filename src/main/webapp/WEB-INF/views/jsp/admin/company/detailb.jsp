                ...
                <div class="wrap_tab">
                    ...
                    <div class="wrap_tabcontent">
                        ...
                        <div id="tab1" class="tabcontent">                         
							   ...
							   <button type="button" class="btn-line-s btn_gray posi_right_0 goBlacklist" data-layer="blacklist">블랙리스트 해제</button>		
								...
								<td>${company.compName }<br /><span class="blchk color_red">(B/L)</span></td>
								<td>
								...
								<section class="btn_wrap m-t-50">
									<button type="button" id="listBtn" class="btn btn_gray" onclick="location.href='/admin/company/listb'">목록</button>
									<section>
