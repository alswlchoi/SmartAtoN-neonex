                        ...
                        <div id="tab1" class="tabcontent">                         
							   ...
							   <section id="data_detail" class="tbl_wrap_list">			
								...
								<c:if test="${company.blackList eq 'Y' }">
									<br /><span class="blchk red">(B/L)</span></td>
								</c:if>
								...
								<section class="btn_wrap m-t-50">
									<button type="button" id="listBtn" class="btn btn_gray" onclick="location.href='/admin/company'">목록</button>
									<section>
								...
								<c:if test="${company.memApproval eq 'N' }">
									<section id="approvalBtn" class="btn_wrap tac m-t-0">
									    <button type="button" class="btn-line-b btn_gray m-r-6"
									        data-layer="reason">회원가입반려</button>
									    <button type="button" id="appBtn" class="btn-sb btn_default">회원가입승인</button>
									</section>
								</c:if>
							   </section>
							   <!-- 상세보기 끝 -->
