...
<sec:csrfMetaTags/>
		...
		$(document).on("click","#pagingc a.pageNo",function(){
			...
			if($(this).attr("data-page")==1){
				$("#pagingc a.btn_prev").addClass("off");
			}else{
				$("#pagingc a.btn_prev").removeClass("off");
			}
			*/
			search("paging");
		});
		...
		$(document).on("click",".goBlacklist",function(){
			...
			var compCode = $("#data_table tbody tr td:eq(0)").text();
		...
		$(document).on("click",".godetail",function(){
			...
			location.href="/admin/company/detail-company?compCode="+compCode+"&blackList=B";
		});
            ...
            <div class="content">
                ...
                <div class="wrap_tab">
                    <div class="tab">
                        ...
                        <button class="tablinks active" onclick="pageMove('tab3')" id="thirdOpen">블랙리스트 내역</button>
                    </div>
                                ...
                                <!-- <div class="form_group m-r-10">
                                    <div class="check_inline">
                                        ...
                                        <label class="check_default">
                                            <input type="checkbox" name="memApproval" id="memApprovalN" value="N" />
                                            <span class="check_icon"></span>승인대기</label>
                                        <label class="check_default">
                                            <input type="checkbox" name="memApproval" id="memApprovalR" value="R" />
                                            <span class="check_icon"></span>승인반려</label>
                                    </div>
                                </div>
                                 -->
