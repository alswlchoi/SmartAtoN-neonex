...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    type = getParam().type;
    if (type == 'N') {
      $("#N").attr('class', 'currentBtn2');
      $("#C").removeClass('currentBtn2');
      $("#statusTable").show();
      $("#rejTable").hide();
      $("#readyBtn").show();
      $("#rejectBtn").hide();
  ...
  function pageMove(str){
    if(str=='tab1'){
      ...
      location.href = '/admin/reserved/shop?type=reject';
    }
  }
  ...
  $(function () {
    ...
    function drawDetail(list) {
      ...
      if (type == 'N') {
        ...
        detailHtml += '<td><span class="color_red">승인대기</span></td>';
        detailHtml += '</tr>';
        ...
        detailHtml += '<span style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width:600px;">';
        for(var i in wssReservDay) {
          detailHtml += ' / '+wssReservDay[i]+'';
        }
        detailHtml += '</span>';
        detailHtml += '</td>';
        detailHtml += '<td>'+list.wsName+'</td>';
        detailHtml += '<td>'+list.compName+'</td>';
        if (list.wssApproval == 'C') {
          detailHtml += '<td><span class="color_red">취소</span><br />';
        } else {
          detailHtml += '<td><span class="color_red">승인반려</span><br />';
          detailHtml += '<button type="button" class="btn-line-s btn_gray" data-layer="reason_result">사유보기</button>';
        }
        detailHtml += '</td>';
        detailHtml += '<td>'+moment(list.wssModDt, "YYYYMMDDhhmmss").format("YYYY.MM.DD hh:mm:ss")+'</td>';
        detailHtml += '</tr>';

        $("#rejList").html(detailHtml);

        if (list.wssMemo != null) {
          $("#rejReason").html('<p>'+list.wssMemo+'</p>');
        } else {
          $("#rejReason").html('사유가 등록되지 않았습니다.');
        }
      }
      var compNameHtml = "";
    ...
    function saveMemo() {
      ...
      postAjax("/admin/reserved/memo", param, "resultAlert2", null, null, null)
    }
  ...
  function bytesHandler(obj){
    var text = $(obj).val();
    $("#rejectReason_txt").text(getTextLength(text));
  }
</script>
                ...
                <div id="tab2" class="tabcontent">
                    ...
                    <div class="webwidget_tab" id="webwidget_tab">
                        <div class="tabContainer2">
                            <ul class="tabHead2">
                                <li id="N" class="currentBtn2"><a href="javascript:pageMove('tab2')">예약승인대기</a></li>
                                <li id="C"><a href="javascript:pageMove('tab3')">예약반려/취소</a></li>
                            </ul>
                        </div>
                        <div class="tabBody2">
                            <ul>
                                ...
                                <li class="tabCot2">
                                    <!-- ready table list -->
                                    <section class="tbl_wrap_list m-t-30" id="statusTable">
                                        <table class="tbl_list" summary="테이블 입니다. 항목으로는 등이 있습니다">
                                            ...
                                            <%--<tr>
                                                ...
                                                <td>워크샵A동</td>
                                                <td>상신브레이크</td>
                                                <td><span class="color_red">승인대기</span></td>
                                            </tr>--%>
                                            </tbody>
                                        </table>
                                    </section>
                                    <!-- //table list -->
                                    <!-- rejected table list -->
                                    <section class="tbl_wrap_list m-t-30" id="rejTable">
                                        <table class="tbl_list" summary="테이블 입니다. 항목으로는 등이 있습니다">
                                            <caption>테이블</caption>
                                            <colgroup>
                                                <col width="" />
                                            ...
                                            <%--<tr>
                                                ...
                                                <td>워크샵A동</td>
                                                <td>상신브레이크</td>
                                                <td><span class="color_red">승인반려</span><br />
                                                    <button type="button" class="btn-line-s btn_gray" data-layer="reason_result">사유보기</button>
                                                </td>
                                    ...
                                    <div class="wrap_accordion2 m-t-30">
                                        <button class="accordion open">
                                            <h3 class="stitle disib vam0">예약 신청자 및 회계 담당자 정보</h3>
                                        </button>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <div class="form_group w_full">
                                                                <textarea name="" id="memo" cols="" rows="5"
                                                                          class="form_control  h100"
                                    ...
                                    <section class="btn_wrap m-t-50">
                                        ...
                                        <section>
                                            <button type="button" class="btn btn_gray m-r-6"
                                                    data-layer="cancel">취소</button>
                                            <button type="button" class="btn btn_default"
                                                    data-layer="complete" onclick="saveMemo()">저장</button>
                                        </section>
                                    </section>
                                    <%--ready--%>
                                    <section class="btn_wrap tac m-t-0" id="readyBtn">
                                        <button type="button" class="btn-line-b btn_gray m-r-6"
                                                data-layer="reason">예약 반려</button>
                                        <button type="button" class="btn-sb btn_default"
                                                data-layer="complete2">예약 승인</button>
                                    </section>
                                    <%--rejected--%>
                                    <section class="btn_wrap tac m-t-0" id="rejectBtn">
                                        <!-- <button type="button" class="btn-line-b btn_gray m-r-6"
                                            data-layer="reason">예약 반려</button> -->
<%--                                        <button type="button" class="btn-sb btn_default">정산서 발행</button>--%>
                                    </section>
                                    <!-- //button -->
                                </li>
                                <!-- //예약승인대기(부대시설) -->
...
<div class="ly_group">
    <article class="layer_Alert complete2">
        ...
        <div class="wrap_btn01">
            ...
            <button type="button" class="btn-pop btn_default lyClose" onclick="saveApproval('Y')">확인</button>
        </div>
        <!-- # 닫기버튼 # -->
...
<div class="ly_group">
    <article class="layer_m reason">
        ...
        <div class="ly_con">
            <div class="info_text03">
                ...
                <div class="form_group w_full m-t-10">
                        <textarea name="" id="rejectReason" cols="" rows="5" class="form_control"
                                  placeholder="반려 사유를 등록해 주세요."></textarea>
                    <div class="count_txt"><span id="rejectReason_txt">0</span> / 500 bytes</div>
                </div>
            </div>
        </div>
        <!-- 버튼 -->
        <div class="wrap_btn01">
            <button type="button" class="btn-pop btn_gray lyClose m-r-11">취소</button>
            <button type="button" class="btn-pop btn_default lyClose" onclick="saveApproval('R')">확인</button>
        </div>
        <!-- # 닫기버튼 # -->
        <button data-fn="lyClose">레이어닫기</button>
    </article>
...
<div class="ly_group">
    <article class="layer_m reason_result">
        ...
        <!-- # 컨텐츠 # -->
        <div class="ly_con">
            <div class="info_text03" id="rejReason">
                <p>시험 정보가 올바르지 않습니다</p>
            </div>
        </div>
        <!-- 버튼 -->
        <div class="wrap_btn01">
